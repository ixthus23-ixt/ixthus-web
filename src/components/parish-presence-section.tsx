        ...
        <div className="mt-14 grid gap-5 lg:grid-cols-3">
          {locations.map((location) => (
            <MotionDiv
              key={location.name}
              variants={fadeUp}
              className="rounded-3xl border border-blue-200/18 bg-white/[0.085] p-7 shadow-[0_24px_80px_rgba(0,0,0,0.24)] backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:border-[#D4AF37]/40 hover:bg-white/[0.12]"
            >
              <div className="mb-6 flex items-center justify-between gap-4">
                <div className="grid h-12 w-12 place-items-center rounded-2xl border border-[#60A5FA]/20 bg-[#60A5FA]/14 text-[#93C5FD]">
